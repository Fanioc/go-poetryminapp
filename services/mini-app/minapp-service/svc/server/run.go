...
import (
	...
	"github.com/fanioc/go-poetryminapp/services/mini-app/minapp-service/handlers"
...
func NewEndpoints() svc.Endpoints {
	...
	var (
		...
		checkusersessionEndpoint = svc.MakeCheckUserSessionEndpoint(service)
		getuserinfoEndpoint      = svc.MakeGetUserInfoEndpoint(service)
		updateuserinfoEndpoint   = svc.MakeUpdateUserInfoEndpoint(service)
		getuserconfigEndpoint    = svc.MakeGetUserConfigEndpoint(service)
		setuserconfigEndpoint    = svc.MakeSetUserConfigEndpoint(service)
	)
